...
class LSM6DSO:
    ...
    def setreg(self, reg, dat):
        # print("data set", dat)
        self.tb[0] = dat
        self.i2c.write_byte_data(self.addr, reg, dat)

    def getreg(self, reg):
        # self.i2c.read_byte_data(self.addr, reg, self.rb)
        self.rb[0] = self.i2c.read_byte_data(self.addr, reg)
        # print("data read", self.rb[0])
        return self.rb[0]

        # self.i2c.write_i2c_block_data(self.mcuI2cAddress, register, data)
